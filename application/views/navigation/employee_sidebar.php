<aside class="main-sidebar">
    <section class="sidebar">
    	<ul class="sidebar-menu" data-widget="tree">
    		...
    		<li><a href="<?php echo site_url('MainController/employeeHome');?>"><i class="fa fa-dashboard"></i> <span>Home Page</span></a></li>
    		<li class="treeview">
		        ...
		        <ul class="treeview-menu">
		            ...
		            <li><a href="<?php echo site_url('MainController/employeeSCList');?>">SC Records (Alive)</a></li>
